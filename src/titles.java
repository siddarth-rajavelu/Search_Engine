...
public class titles
{
    public static void main(String[] args) {
          ...
          File folder = new File("/media/8238548D38548259/newcrawlStoragehtml");
		  ...
		  for(int i=0;i<fileList.length;i++)
		    {
			  ...
			  //System.out.print(i+" ");
	    	    ...
	    	    List <String> tokens=Utilities.tokenizeTitle(fileList[i]);
	    	    ...
	    	    while(ksIterator.hasNext())
	    	    {
	    	    	...
	    	    	st.executeUpdate("insert into titles values('"+k+"','"+url+"','"+pos+"');");
	    	    }
	    	    }
		    	catch(Exception e)
		    	{
